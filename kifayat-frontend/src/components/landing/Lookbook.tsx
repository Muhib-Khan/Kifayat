            ...
            const inner = (
              <>
                ...
                >
                  ...
                  <span className="absolute top-4 right-4 eyebrow text-bone bg-coal/70 backdrop-blur-sm px-2 py-1 opacity-0 [@media(hover:hover)]:group-hover:opacity-100 transition">
                    View ↗
                  </span>
                </motion.div>
