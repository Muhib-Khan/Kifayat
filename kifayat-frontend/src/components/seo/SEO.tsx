...
const DEFAULT_DESCRIPTION =
  "Kifayat — Pakistan's trusted online store for quality products. Shop electronics, fashion, home goods and more, delivered all across Pakistan. Flat delivery — Cheapest Delivery in Pakistan.";
