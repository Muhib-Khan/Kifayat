  ...
  return (
    ...
    >
      <img
        ...
        loading="lazy"
        decoding="async"
        className="size-full object-contain transition-transform duration-500 ease-out hover:scale-[1.45] motion-reduce:transition-none motion-reduce:hover:scale-100"
      />
    </div>
  );
}